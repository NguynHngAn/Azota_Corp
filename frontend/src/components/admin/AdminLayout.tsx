...
export function AdminLayout() {
  ...
  const nav: NavItem[] = useMemo(
    () => [
      ...
      { key: "classes", to: "/admin/classes", label: t("nav.classes", lang), icon: Icons.Layers },
        ...
        <aside className="app-sidebar hidden md:flex shrink-0 flex-col border-r border-[var(--border-soft)] bg-[var(--panel-bg)] min-h-screen">
          <div className="px-5 py-5 flex items-center gap-3">
            ...
            <div className="leading-tight sidebar-brand">
              ...
              <div className="text-xs text-slate-500">{t("role.admin", lang)}</div>
            </div>
          </div>

          <div className="px-5 pb-2">
            <div className="text-[10px] font-semibold text-slate-400 tracking-widest">ADMIN</div>
          </div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
              <div className="flex-1">
                <div className="relative max-w-lg">
                  <input
                    type="text"
                    placeholder={t("common.searchPlaceholderAdmin", lang)}
