...
const testimonials = [
  ...
  {
    quote:
      "We deployed this across 12 departments. The admin dashboard makes managing 200+ teachers seamless.",
...
const faqs = [
  {
    ...
    a: "Yes! Our free plan lets you create up to 5 exams per month with 30 students. No credit card required.",
  },
  {
    q: "Do students need to install anything?",
    a: "No. Students access exams through any web browser on desktop, tablet, or mobile. No app download needed.",
  },
  {
  ...
  {
    q: "Is my data secure?",
    a: "Absolutely. All data is encrypted at rest and in transit. We comply with GDPR and maintain SOC 2 certification.",
  },
  {
...
function SectionHeader({
  ...
  return (
    ...
    >
      <motion.p
        variants={fadeUp}
        className="text-sm font-semibold text-primary mb-3 tracking-wide uppercase"
      >
        {badge}
      </motion.p>
      <motion.h2
        variants={fadeUp}
        className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-foreground tracking-tight leading-[1.15]"
      >
        {title}
      </motion.h2>
      {subtitle && (
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/signup">
                <Button
                  size="sm"
                  className="rounded-full px-5 shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-shadow"
                >
                  Get started
                </Button>
              </Link>
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <FloatingOrb
            className="w-[500px] h-[500px] bg-accent/30 top-20 right-[-10%]"
            delay={2}
          />
          <FloatingOrb
            className="w-[400px] h-[400px] bg-info/25 bottom-0 left-1/3"
            delay={4}
          />
        ...
        <motion.div
          ...
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 lg:pt-20 lg:pb-32 relative w-full"
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              An all-in-one platform for teachers to create tests, monitor
              exams, and analyze student performance — saving hours every week.
            </motion.p>
            ...
            >
              ...
              <span className="flex items-center gap-1">
                <CheckCircle className="w-3 h-3 text-accent" /> Free forever
                plan
              </span>
              <span className="flex items-center gap-1">
      ...
      <section id="features" className="py-24 lg:py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <SectionHeader
            badge="Features"
            title="Everything you need to run exams online"
            subtitle="From exam creation to analytics — all the tools teachers need, in one platform."
          />
          <motion.div
            initial="hidden"
            whileInView="visible"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative rounded-2xl border border-border/60 bg-card/80 backdrop-blur-xl shadow-2xl shadow-accent/5 overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  {[
                    ...
                    {
                      q: "Q4. Which element has atomic number 6?",
                      correct: false,
                    },
                    ...
                    >
                      ...
                      <div
                        className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 ml-3 ${item.correct ? "bg-accent/20 text-accent" : "bg-destructive/20 text-destructive"}`}
                      >
                        {item.correct ? (
            ...
            >
              <motion.p
                variants={fadeUp}
                className="text-sm font-semibold text-accent mb-3 uppercase tracking-wide"
              >
                Grading & Results
              </motion.p>
              <motion.h2
              ...
              <motion.p
                ...
                className="mt-5 text-muted-foreground text-lg leading-relaxed"
              >
                No more hours spent grading papers. The platform scores every
                submission the moment it's turned in — students see their
                results, correct answers, and performance breakdown immediately.
              </motion.p>
              <motion.div
                variants={staggerContainer}
              ...
              >
                {[
                  {
                    text: "Scores calculated in under a second",
                    icon: <Zap className="w-3.5 h-3.5" />,
                  },
                  {
                    text: "Students see results immediately after submitting",
                    icon: <Sparkles className="w-3.5 h-3.5" />,
                  },
                  {
                    text: "Question-by-question breakdown with correct answers",
                    icon: <FileText className="w-3.5 h-3.5" />,
                  },
                  {
                    text: "Teachers get class-wide score summaries automatically",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p
                ...
                className="mt-5 text-muted-foreground text-lg leading-relaxed"
              >
                Every exam generates rich analytics automatically. Spot
                struggling students, identify tricky questions, and track class
                progress over time — all without spreadsheets.
              </motion.p>
              ...
              >
                {[
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-xl ${item.color} flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform`}
                    >
                      {item.icon}
                    </div>
                    <div>
                ...
                <div className="px-6 py-4 border-b border-border/50 bg-muted/20 flex items-center justify-between">
                  ...
                  <div className="flex gap-1">
                    {["7D", "30D", "All"].map((period, i) => (
                      <span
                        key={period}
                        className={`text-[10px] px-2.5 py-1 rounded-md cursor-pointer transition-colors ${i === 1 ? "bg-primary text-primary-foreground" : "bg-muted/50 text-muted-foreground hover:bg-muted"}`}
                      >
                        {period}
                      </span>
                    ))}
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {[
                      ...
                      <div
                        key={stat.label}
                        className="rounded-lg bg-muted/30 border border-border/20 p-3 text-center hover:bg-muted/50 transition-colors"
                      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.p
                variants={fadeUp}
                className="text-sm font-semibold text-destructive mb-3 uppercase tracking-wide"
              >
                Exam Integrity
              </motion.p>
              <motion.h2
              ...
              <motion.p
                ...
                className="mt-5 text-muted-foreground text-lg leading-relaxed"
              >
                Three layers of protection work together to ensure every exam is
                taken honestly — without disrupting the student experience.
              </motion.p>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {/* Tab switches */}
                        <div
                          className={`flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full ${student.tabs > 2 ? "bg-warning/20 text-warning" : "bg-muted/50 text-muted-foreground"}`}
                        >
                        ...
                        {/* Fullscreen */}
                        <div
                          className={`w-5 h-5 rounded-full flex items-center justify-center ${student.fullscreen ? "bg-accent/20 text-accent" : "bg-destructive/20 text-destructive"}`}
                        >
                          <Shield className="w-2.5 h-2.5" />
                        </div>
                        {/* Webcam */}
                        <div
                          className={`w-5 h-5 rounded-full flex items-center justify-center ${student.webcam ? "bg-accent/20 text-accent" : "bg-destructive/20 text-destructive"}`}
                        >
                ...
                <div className="px-5 py-3 border-t border-border/30 bg-muted/10 flex items-center justify-between">
                  <div className="flex items-center gap-4 text-[10px]">
                    <span className="flex items-center gap-1 text-accent">
                      <span className="w-2 h-2 rounded-full bg-accent" /> 24
                      Clean
                    </span>
                    <span className="flex items-center gap-1 text-warning">
                      <span className="w-2 h-2 rounded-full bg-warning" /> 3
                      Warnings
                    </span>
                    <span className="flex items-center gap-1 text-destructive">
                      <span className="w-2 h-2 rounded-full bg-destructive" /> 1
                      Flagged
                    </span>
                  </div>
                </div>
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <SectionHeader
            badge="Customization"
            title="Make it yours — every detail"
            subtitle="Language switching, theme preferences, and UI settings that let every user feel at home."
          />
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      >
                        ...
                        <div
                          className={`w-9 h-5 rounded-full flex items-center transition-colors ${p.on ? "bg-primary justify-end" : "bg-muted justify-start"}`}
                        >
              ...
              {[
                {
                  ...
                  desc: "Seamlessly switch between Vietnamese, English, Japanese, and more. The entire interface adapts instantly — menus, labels, notifications, and exam content.",
                },
                {
                  icon: <Palette className="w-5 h-5" />,
                  title: "Theme & appearance",
                  desc: "Choose Light, Dark, or System themes. Each theme is carefully crafted for readability and comfort during long grading or exam sessions.",
                },
                {
                  icon: <SlidersHorizontal className="w-5 h-5" />,
                  title: "User UI preferences",
                  desc: "Customize sidebar layout, notification sounds, timer visibility, and display density. Your preferences sync across all devices automatically.",
                },
              ].map((item) => (
                <motion.div
                  key={item.title}
          ...
          >
            {testimonials.map((t) => (
              ...
              >
                ...
                <p className="text-sm text-foreground leading-relaxed mb-7">
                  "{t.quote}"
                </p>
                <div className="flex items-center gap-3">
            ...
            <div className="relative p-12 sm:p-20 text-center">
              ...
              <div className="mt-10">
                <Link to="/signup">
                  <Button
                    size="lg"
                    className="rounded-full px-10 h-13 text-base gap-2 bg-primary-foreground text-primary hover:bg-primary-foreground/90 shadow-2xl hover:scale-[1.03] transition-all duration-300 group"
                  >
                    Get started free{" "}
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                  </Button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Modern online exam and learning management for educators.
              </p>
            </div>
            {[
              {
              ...
              {
                title: "Resources",
                links: ["Documentation", "Blog", "Tutorials", "API"],
              },
              {
                title: "Company",
              ...
              {
                title: "Legal",
                links: ["Terms", "Privacy", "Security", "GDPR"],
              },
            ].map((col) => (
              <div key={col.title}>
                <h4 className="text-xs font-semibold text-foreground uppercase tracking-[0.15em] mb-5">
                  {col.title}
                </h4>
