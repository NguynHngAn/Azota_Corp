...
import type { ScoreBucket } from "@/services/types";
...
const AssignmentsPage = () => {
  ...
  const fetchAssignments = useCallback(async () => {
    try {
      setLoading(true);
      const res = await assignmentsService.list(token);
  ...
  const handleDelete = async () => {
    // Backend currently doesn't expose an assignment delete endpoint.
    toast.error("Delete is not supported yet");
  };
